      ...
      <Carousel className="text-dark">
        <Carousel.Item interval={1000}>
          <img 
            ...
            src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
            alt="First slide"
          />
        ...
        <Carousel.Item>
          <img
            className="d-block w-100 banner"
            src="https://images.unsplash.com/photo-1599045118108-bf9954418b76?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"
            alt="Third slide"
          />
          <Carousel.Caption className=" ">
          <h3>Our Pharmacy Manegment </h3>
